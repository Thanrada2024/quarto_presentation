...
<div style="font-family:'Inter','Sarabun',sans-serif;font-size:0.58em;width:100%;box-sizing:border-box;display:flex;flex-direction:column;gap:0.28em;">
  ...
  <!-- Body: 2 columns -->
  <div style="display:grid;grid-template-columns:1fr 1fr;gap:0.42em;">
    ...
    <div>
      ...
      <div style="display:flex;flex-direction:column;gap:0.1em;">
        <div style="display:flex;align-items:center;gap:0.34em;background:rgba(124,77,255,0.06);border-left:2px solid rgba(124,77,255,0.38);border-radius:0 5px 5px 0;padding:0.18em 0.42em;">
    ...
    <div>
      ...
      <div style="display:flex;flex-direction:column;gap:0.1em;">
        <div style="display:flex;align-items:center;gap:0.34em;background:rgba(0,230,118,0.05);border-left:2px solid rgba(0,230,118,0.32);border-radius:0 5px 5px 0;padding:0.18em 0.42em;">
          <span style="font-size:1em;flex-shrink:0;">🏛️</span>
          <div style="min-width:0;">
  ...
  <!-- Stakeholders: horizontal bottom row -->
  <div style="background:rgba(8,18,40,0.6);border:1px solid rgba(239,83,80,0.2);border-radius:10px;padding:0.4em 0.6em;">
    <div style="display:flex;align-items:center;gap:0.3em;margin-bottom:0.28em;">
      <div style="width:20px;height:20px;min-width:20px;background:linear-gradient(135deg,#EF5350,#C62828);border-radius:5px;display:flex;align-items:center;justify-content:center;font-size:0.75em;">👥</div>
      <div style="color:#EF8080;font-weight:800;font-size:0.72em;">ผู้ได้รับประโยชน์ <span style="color:rgba(239,83,80,0.5);font-weight:400;">· Stakeholders</span></div>
    </div>
    <div style="display:grid;grid-template-columns:repeat(6,1fr);gap:0.3em;">

      <div style="background:rgba(239,83,80,0.06);border:1px solid rgba(239,83,80,0.18);border-radius:8px;padding:0.3em 0.35em;text-align:center;display:flex;flex-direction:column;align-items:center;gap:0.12em;">
        <div style="width:30px;height:30px;background:rgba(239,83,80,0.12);border-radius:8px;display:flex;align-items:center;justify-content:center;font-size:1.1em;">👨‍💼</div>
        <div style="font-weight:700;font-size:0.62em;color:#EF9090;line-height:1.2;">ทีม Data<br>Governance</div>
        <div style="font-size:0.55em;color:#406070;line-height:1.2;">Enforce นโยบาย<br>ลดภาระ Manual</div>
      </div>

      <div style="background:rgba(239,83,80,0.06);border:1px solid rgba(239,83,80,0.18);border-radius:8px;padding:0.3em 0.35em;text-align:center;display:flex;flex-direction:column;align-items:center;gap:0.12em;">
        <div style="width:30px;height:30px;background:rgba(239,83,80,0.12);border-radius:8px;display:flex;align-items:center;justify-content:center;font-size:1.1em;">🗝️</div>
        <div style="font-weight:700;font-size:0.62em;color:#EF9090;line-height:1.2;">Data Owner<br>/ Steward</div>
        <div style="font-size:0.55em;color:#406070;line-height:1.2;">รู้สถานะข้อมูล<br>มี Alert แจ้งเตือน</div>
      </div>

      <div style="background:rgba(239,83,80,0.06);border:1px solid rgba(239,83,80,0.18);border-radius:8px;padding:0.3em 0.35em;text-align:center;display:flex;flex-direction:column;align-items:center;gap:0.12em;">
        <div style="width:30px;height:30px;background:rgba(239,83,80,0.12);border-radius:8px;display:flex;align-items:center;justify-content:center;font-size:1.1em;">🔐</div>
        <div style="font-weight:700;font-size:0.62em;color:#EF9090;line-height:1.2;">ทีม IT<br>/ Security</div>
        <div style="font-size:0.55em;color:#406070;line-height:1.2;">ลดความเสี่ยง<br>Credential · PII</div>
      </div>

      <div style="background:rgba(239,83,80,0.06);border:1px solid rgba(239,83,80,0.18);border-radius:8px;padding:0.3em 0.35em;text-align:center;display:flex;flex-direction:column;align-items:center;gap:0.12em;">
        <div style="width:30px;height:30px;background:rgba(239,83,80,0.12);border-radius:8px;display:flex;align-items:center;justify-content:center;font-size:1.1em;">📊</div>
        <div style="font-weight:700;font-size:0.62em;color:#EF9090;line-height:1.2;">ผู้บริหาร<br>ETDA</div>
        <div style="font-size:0.55em;color:#406070;line-height:1.2;">Data Catalog<br>ตัดสินใจได้เร็ว</div>
      </div>

      <div style="background:rgba(239,83,80,0.06);border:1px solid rgba(239,83,80,0.18);border-radius:8px;padding:0.3em 0.35em;text-align:center;display:flex;flex-direction:column;align-items:center;gap:0.12em;">
        <div style="width:30px;height:30px;background:rgba(239,83,80,0.12);border-radius:8px;display:flex;align-items:center;justify-content:center;font-size:1.1em;">🏢</div>
        <div style="font-weight:700;font-size:0.62em;color:#EF9090;line-height:1.2;">พนักงาน<br>ทั่วไป</div>
        <div style="font-size:0.55em;color:#406070;line-height:1.2;">จัดเก็บและใช้ข้อมูล<br>มีประสิทธิภาพขึ้น</div>
      </div>

      <div style="background:rgba(239,83,80,0.06);border:1px solid rgba(239,83,80,0.18);border-radius:8px;padding:0.3em 0.35em;text-align:center;display:flex;flex-direction:column;align-items:center;gap:0.12em;">
        <div style="width:30px;height:30px;background:rgba(239,83,80,0.12);border-radius:8px;display:flex;align-items:center;justify-content:center;font-size:1.1em;">🤖</div>
        <div style="font-weight:700;font-size:0.62em;color:#EF9090;line-height:1.2;">ทีม Data<br>Science / AI</div>
        <div style="font-size:0.55em;color:#406070;line-height:1.2;">ข้อมูลสะอาด<br>พร้อมต่อยอด</div>
      </div>
