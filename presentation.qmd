...
```{=html}
<div style="font-family:'Inter','Sarabun',sans-serif;font-size:0.62em;width:100%;box-sizing:border-box;display:flex;flex-direction:column;gap:0.3em;">
  ...
  <div style="display:grid;grid-template-columns:1fr 1fr;gap:0.45em;">
    ...
    <!-- วัตถุประสงค์ -->
    <div>
      <div style="display:flex;align-items:center;gap:0.38em;margin-bottom:0.18em;padding-bottom:0.14em;border-bottom:1px solid rgba(0,188,212,0.18);">
        <div style="width:26px;height:26px;min-width:26px;background:linear-gradient(135deg,#00BCD4,#0288D1);border-radius:7px;display:flex;align-items:center;justify-content:center;font-size:0.92em;box-shadow:0 2px 7px rgba(0,188,212,0.4);">🎯</div>
        <div>
          <div style="color:#00BCD4;font-weight:800;font-size:0.92em;">วัตถุประสงค์หลัก</div>
          <div style="color:rgba(0,188,212,0.5);font-size:0.56em;font-weight:600;letter-spacing:0.04em;">OBJECTIVES</div>
        </div>
      </div>
      <div style="display:flex;flex-direction:column;gap:0.1em;">
        <div style="display:flex;align-items:center;gap:0.35em;background:rgba(0,188,212,0.06);border-left:2px solid rgba(0,188,212,0.4);border-radius:0 6px 6px 0;padding:0.16em 0.44em;">
          <span style="width:16px;height:16px;min-width:16px;background:rgba(0,188,212,0.2);border-radius:3px;display:flex;align-items:center;justify-content:center;font-size:0.54em;color:#00BCD4;font-weight:800;flex-shrink:0;">1</span>
          <span style="font-size:0.8em;color:#A0B4C8;line-height:1.3;">พัฒนา <strong style="color:#00BCD4;">Automation</strong> แปลงนโยบาย Data Governance ให้บังคับใช้ได้จริง</span>
        </div>
        <div style="display:flex;align-items:center;gap:0.35em;background:rgba(0,188,212,0.06);border-left:2px solid rgba(0,188,212,0.4);border-radius:0 6px 6px 0;padding:0.16em 0.44em;">
          <span style="width:16px;height:16px;min-width:16px;background:rgba(0,188,212,0.2);border-radius:3px;display:flex;align-items:center;justify-content:center;font-size:0.54em;color:#00BCD4;font-weight:800;flex-shrink:0;">2</span>
          <span style="font-size:0.8em;color:#A0B4C8;line-height:1.3;">ยกระดับ <strong style="color:#00BCD4;">Policy Enforcement</strong> ให้สม่ำเสมอทั่วองค์กร ลด Manual Process</span>
        </div>
        <div style="display:flex;align-items:center;gap:0.35em;background:rgba(0,188,212,0.06);border-left:2px solid rgba(0,188,212,0.4);border-radius:0 6px 6px 0;padding:0.16em 0.44em;">
          <span style="width:16px;height:16px;min-width:16px;background:rgba(0,188,212,0.2);border-radius:3px;display:flex;align-items:center;justify-content:center;font-size:0.54em;color:#00BCD4;font-weight:800;flex-shrink:0;">3</span>
          <span style="font-size:0.8em;color:#A0B4C8;line-height:1.3;">พัฒนา <strong style="color:#00BCD4;">AI Auto-Classification</strong> จำแนกชั้นความลับ + ประเภทเอกสาร + Retention</span>
        </div>
        <div style="display:flex;align-items:center;gap:0.35em;background:rgba(0,188,212,0.06);border-left:2px solid rgba(0,188,212,0.4);border-radius:0 6px 6px 0;padding:0.16em 0.44em;">
          <span style="width:16px;height:16px;min-width:16px;background:rgba(0,188,212,0.2);border-radius:3px;display:flex;align-items:center;justify-content:center;font-size:0.54em;color:#00BCD4;font-weight:800;flex-shrink:0;">4</span>
          <span style="font-size:0.8em;color:#A0B4C8;line-height:1.3;">สร้าง <strong style="color:#00BCD4;">Data Catalog</strong> กลาง แสดงสถานะข้อมูลและ Compliance แบบ Real-time</span>
        </div>
        <div style="display:flex;align-items:center;gap:0.35em;background:rgba(0,188,212,0.06);border-left:2px solid rgba(0,188,212,0.4);border-radius:0 6px 6px 0;padding:0.16em 0.44em;">
          <span style="width:16px;height:16px;min-width:16px;background:rgba(0,188,212,0.2);border-radius:3px;display:flex;align-items:center;justify-content:center;font-size:0.54em;color:#00BCD4;font-weight:800;flex-shrink:0;">5</span>
          <span style="font-size:0.8em;color:#A0B4C8;line-height:1.3;">วางรากฐานสู่ <strong style="color:#00BCD4;">Data-Driven Organization</strong> ที่ยั่งยืน</span>
        </div>
      </div>
    </div>
    ...
    <!-- ประโยชน์ -->
    <div>
      <div style="display:flex;align-items:center;gap:0.38em;margin-bottom:0.18em;padding-bottom:0.14em;border-bottom:1px solid rgba(0,230,118,0.18);">
        <div style="width:26px;height:26px;min-width:26px;background:linear-gradient(135deg,#00E676,#00C853);border-radius:7px;display:flex;align-items:center;justify-content:center;font-size:0.92em;box-shadow:0 2px 7px rgba(0,230,118,0.35);">💡</div>
        <div>
          <div style="color:#00E676;font-weight:800;font-size:0.92em;">ประโยชน์ที่คาดว่าจะได้รับ</div>
          <div style="color:rgba(0,230,118,0.5);font-size:0.56em;font-weight:600;letter-spacing:0.04em;">EXPECTED BENEFITS</div>
        </div>
      </div>
      <div style="display:flex;flex-direction:column;gap:0.1em;">

        <div style="display:flex;align-items:center;gap:0.4em;background:rgba(0,188,212,0.06);border-left:2px solid rgba(0,188,212,0.38);border-radius:0 6px 6px 0;padding:0.16em 0.44em;">
          <span style="font-size:1.1em;flex-shrink:0;">⚙️</span>
          <div style="min-width:0;">
            <div style="font-weight:700;font-size:0.78em;color:#00BCD4;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">นโยบายถูกบังคับใช้จริงทั่วองค์กร</div>
            <div style="font-size:0.68em;color:#456070;line-height:1.25;">Automation จัดการ Lifecycle ครบวงจร ไม่ต้องพึ่ง Manual</div>
          </div>
        </div>

        <div style="display:flex;align-items:center;gap:0.4em;background:rgba(0,230,118,0.05);border-left:2px solid rgba(0,230,118,0.38);border-radius:0 6px 6px 0;padding:0.16em 0.44em;">
          <span style="font-size:1.1em;flex-shrink:0;">✅</span>
          <div style="min-width:0;">
            <div style="font-weight:700;font-size:0.78em;color:#00E676;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">คุณภาพข้อมูลและความพร้อมใช้งานเพิ่มขึ้น</div>
            <div style="font-size:0.68em;color:#456070;line-height:1.25;">ติด Label อัตโนมัติ ระบุผู้รับผิดชอบได้ ลดข้อมูลซ้ำซ้อน</div>
          </div>
        </div>

        <div style="display:flex;align-items:center;gap:0.4em;background:rgba(124,77,255,0.05);border-left:2px solid rgba(124,77,255,0.38);border-radius:0 6px 6px 0;padding:0.16em 0.44em;">
          <span style="font-size:1.1em;flex-shrink:0;">🗂️</span>
          <div style="min-width:0;">
            <div style="font-weight:700;font-size:0.78em;color:#9B72FF;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">ค้นหาและเข้าถึงข้อมูลได้เร็วขึ้น</div>
            <div style="font-size:0.68em;color:#456070;line-height:1.25;">Data Catalog บอกแหล่งจัดเก็บ เจ้าของ และสถานะทันที</div>
          </div>
        </div>

        <div style="display:flex;align-items:center;gap:0.4em;background:rgba(255,179,0,0.05);border-left:2px solid rgba(255,179,0,0.38);border-radius:0 6px 6px 0;padding:0.16em 0.44em;">
          <span style="font-size:1.1em;flex-shrink:0;">🚀</span>
          <div style="min-width:0;">
            <div style="font-weight:700;font-size:0.78em;color:#FFB300;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">รากฐานสู่ Data-Driven Organization</div>
            <div style="font-size:0.68em;color:#456070;line-height:1.25;">ข้อมูลสะอาด พร้อมต่อยอด Analytics และ AI ได้ทันที</div>
          </div>
        </div>

        <div style="display:flex;align-items:center;gap:0.4em;background:rgba(239,83,80,0.05);border-left:2px solid rgba(239,83,80,0.38);border-radius:0 6px 6px 0;padding:0.16em 0.44em;">
          <span style="font-size:1.1em;flex-shrink:0;">🔒</span>
          <div style="min-width:0;">
            <div style="font-weight:700;font-size:0.78em;color:#EF8080;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">ลดความเสี่ยง PDPA & Data Leak</div>
            <div style="font-size:0.68em;color:#456070;line-height:1.25;">PII ถูกตรวจจับและจัดการอัตโนมัติตั้งแต่ต้น</div>
          </div>
        </div>
...
<!-- ═══ SLIDE 6c: Output · Outcome · ผลกระทบ ═══ -->
## 📋 ข้อเสนอโครงการ — Output · Outcome · ผลกระทบ {background-color="#0A1628"}

```{=html}
<div style="font-family:'Inter','Sarabun',sans-serif;font-size:0.58em;width:100%;box-sizing:border-box;display:flex;flex-direction:column;gap:0.28em;">
  ...
  <!-- Body: 3 columns -->
  <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:0.42em;">

    <!-- Output -->
    <div>
      <div style="display:flex;align-items:center;gap:0.35em;margin-bottom:0.16em;padding-bottom:0.13em;border-bottom:1px solid rgba(124,77,255,0.2);">
        <div style="width:24px;height:24px;min-width:24px;background:linear-gradient(135deg,#7C4DFF,#5E35B1);border-radius:6px;display:flex;align-items:center;justify-content:center;font-size:0.86em;box-shadow:0 2px 6px rgba(124,77,255,0.4);">📦</div>
        <div>
          <div style="color:#B39DFF;font-weight:800;font-size:0.9em;">Output <span style="color:rgba(124,77,255,0.5);font-size:0.8em;font-weight:400;">(ผลผลิต)</span></div>
        </div>
      </div>
      <div style="display:flex;flex-direction:column;gap:0.1em;">
        <div style="display:flex;align-items:center;gap:0.34em;background:rgba(124,77,255,0.06);border-left:2px solid rgba(124,77,255,0.38);border-radius:0 5px 5px 0;padding:0.15em 0.42em;">
          <span style="font-size:1em;flex-shrink:0;">📊</span>
          <div style="min-width:0;">
            <div style="font-weight:700;font-size:0.78em;color:#B39DFF;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">Current State Assessment</div>
            <div style="font-size:0.67em;color:#456070;line-height:1.25;">วัด Gap สถานะปัจจุบัน vs นโยบาย</div>
          </div>
        </div>
        <div style="display:flex;align-items:center;gap:0.34em;background:rgba(124,77,255,0.06);border-left:2px solid rgba(124,77,255,0.38);border-radius:0 5px 5px 0;padding:0.15em 0.42em;">
          <span style="font-size:1em;flex-shrink:0;">🏷️</span>
          <div style="min-width:0;">
            <div style="font-weight:700;font-size:0.78em;color:#B39DFF;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">AI Auto-Classification & Labelling</div>
            <div style="font-size:0.67em;color:#456070;line-height:1.25;">Public / Internal / Conf. + ประเภท + Retention</div>
          </div>
        </div>
        <div style="display:flex;align-items:center;gap:0.34em;background:rgba(124,77,255,0.06);border-left:2px solid rgba(124,77,255,0.38);border-radius:0 5px 5px 0;padding:0.15em 0.42em;">
          <span style="font-size:1em;flex-shrink:0;">⏳</span>
          <div style="min-width:0;">
            <div style="font-weight:700;font-size:0.78em;color:#B39DFF;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">Automated Lifecycle Workflow</div>
            <div style="font-size:0.67em;color:#456070;line-height:1.25;">แจ้งเตือน Data Owner · Archive อัตโนมัติ</div>
          </div>
        </div>
        <div style="display:flex;align-items:center;gap:0.34em;background:rgba(124,77,255,0.06);border-left:2px solid rgba(124,77,255,0.38);border-radius:0 5px 5px 0;padding:0.15em 0.42em;">
          <span style="font-size:1em;flex-shrink:0;">🗂️</span>
          <div style="min-width:0;">
            <div style="font-weight:700;font-size:0.78em;color:#B39DFF;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">Data Catalog + Gov. Dashboard</div>
            <div style="font-size:0.67em;color:#456070;line-height:1.25;">Compliance Real-time · รู้แหล่ง · รู้เจ้าของ</div>
          </div>
        </div>
      </div>
    </div>
    ...
    <!-- Outcome -->
    <div>
      <div style="display:flex;align-items:center;gap:0.35em;margin-bottom:0.16em;padding-bottom:0.13em;border-bottom:1px solid rgba(0,230,118,0.2);">
        <div style="width:24px;height:24px;min-width:24px;background:linear-gradient(135deg,#00E676,#00C853);border-radius:6px;display:flex;align-items:center;justify-content:center;font-size:0.86em;box-shadow:0 2px 6px rgba(0,230,118,0.35);">🌱</div>
        <div>
          <div style="color:#00E676;font-weight:800;font-size:0.9em;">Outcome <span style="color:rgba(0,230,118,0.5);font-size:0.8em;font-weight:400;">(ผลลัพธ์)</span></div>
        </div>
      </div>
      <div style="display:flex;flex-direction:column;gap:0.1em;">
        <div style="display:flex;align-items:center;gap:0.34em;background:rgba(0,230,118,0.05);border-left:2px solid rgba(0,230,118,0.32);border-radius:0 5px 5px 0;padding:0.15em 0.42em;">
          <span style="font-size:1em;flex-shrink:0;">🏛️</span>
          <div style="min-width:0;">
            <div style="font-weight:700;font-size:0.78em;color:#00E676;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">Improved Data Governance</div>
            <div style="font-size:0.67em;color:#456070;line-height:1.25;">กำกับชัดเจน ลด Silo บทบาท Owner/Steward ชัด</div>
          </div>
        </div>
        <div style="display:flex;align-items:center;gap:0.34em;background:rgba(0,230,118,0.05);border-left:2px solid rgba(0,230,118,0.32);border-radius:0 5px 5px 0;padding:0.15em 0.42em;">
          <span style="font-size:1em;flex-shrink:0;">✨</span>
          <div style="min-width:0;">
            <div style="font-weight:700;font-size:0.78em;color:#00E676;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">Better Data Quality & Usability</div>
            <div style="font-size:0.67em;color:#456070;line-height:1.25;">ลดซ้ำซ้อน มีหมวดหมู่ ค้นหาง่าย ใช้ได้เลย</div>
          </div>
        </div>
        <div style="display:flex;align-items:center;gap:0.34em;background:rgba(0,230,118,0.05);border-left:2px solid rgba(0,230,118,0.32);border-radius:0 5px 5px 0;padding:0.15em 0.42em;">
          <span style="font-size:1em;flex-shrink:0;">🤖</span>
          <div style="min-width:0;">
            <div style="font-weight:700;font-size:0.78em;color:#00E676;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">Future AI Readiness</div>
            <div style="font-size:0.67em;color:#456070;line-height:1.25;">ฐานข้อมูลพร้อมต่อยอด Analytics และ AI ได้ทันที</div>
          </div>
        </div>
        <div style="display:flex;align-items:center;gap:0.34em;background:rgba(0,230,118,0.05);border-left:2px solid rgba(0,230,118,0.32);border-radius:0 5px 5px 0;padding:0.15em 0.42em;">
          <span style="font-size:1em;flex-shrink:0;">📈</span>
          <div style="min-width:0;">
            <div style="font-weight:700;font-size:0.78em;color:#00E676;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">Operational Efficiency</div>
            <div style="font-size:0.67em;color:#456070;line-height:1.25;">ลดเวลาค้นหา ลดภาระ Manual ลดต้นทุนแฝง</div>
          </div>
        </div>
      </div>
    </div>

    <!-- ผลกระทบ + ผู้ได้รับประโยชน์ -->
    <div style="display:flex;flex-direction:column;gap:0.1em;">

      <div style="display:flex;align-items:center;gap:0.34em;padding-bottom:0.12em;border-bottom:1px solid rgba(255,167,38,0.18);">
        <div style="width:24px;height:24px;min-width:24px;background:linear-gradient(135deg,#FFA726,#F57C00);border-radius:6px;display:flex;align-items:center;justify-content:center;font-size:0.86em;">⚡</div>
        <div style="color:#FFA726;font-weight:800;font-size:0.9em;">ผลกระทบ <span style="color:rgba(255,167,38,0.5);font-size:0.8em;font-weight:400;">· Impact</span></div>
      </div>

      <div style="display:flex;align-items:center;gap:0.34em;background:rgba(255,167,38,0.06);border-left:2px solid rgba(255,167,38,0.32);border-radius:0 5px 5px 0;padding:0.15em 0.4em;">
        <span style="font-size:0.95em;flex-shrink:0;">🏢</span>
        <div style="min-width:0;">
          <div style="font-weight:700;font-size:0.76em;color:#FFA726;">Internal Management</div>
          <div style="font-size:0.65em;color:#456070;line-height:1.25;">นโยบายถูก Enforce จริงในวงกว้าง</div>
        </div>
      </div>
      <div style="display:flex;align-items:center;gap:0.34em;background:rgba(255,167,38,0.06);border-left:2px solid rgba(255,167,38,0.32);border-radius:0 5px 5px 0;padding:0.15em 0.4em;">
        <span style="font-size:0.95em;flex-shrink:0;">🔒</span>
        <div style="min-width:0;">
          <div style="font-weight:700;font-size:0.76em;color:#FFA726;">Security & Compliance</div>
          <div style="font-size:0.65em;color:#456070;line-height:1.25;">ลด PII Exposure · ลดความเสี่ยง PDPA</div>
        </div>
      </div>

      <div style="display:flex;align-items:center;gap:0.2em;margin:0.05em 0;">
      ...
      <div style="display:flex;flex-direction:column;gap:0.1em;">
        <div style="display:flex;align-items:center;gap:0.32em;background:rgba(239,83,80,0.06);border-left:2px solid rgba(239,83,80,0.28);border-radius:0 5px 5px 0;padding:0.13em 0.4em;">
          <span style="font-size:0.92em;flex-shrink:0;">👨‍💼</span>
          <div style="min-width:0;overflow:hidden;">
            <div style="font-weight:700;font-size:0.74em;color:#EF9090;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">ทีม Data Governance</div>
            <div style="font-size:0.63em;color:#456070;line-height:1.2;">มีเครื่องมือ Enforce นโยบาย ลดภาระ Manual</div>
          </div>
        </div>
        <div style="display:flex;align-items:center;gap:0.32em;background:rgba(239,83,80,0.06);border-left:2px solid rgba(239,83,80,0.28);border-radius:0 5px 5px 0;padding:0.13em 0.4em;">
          <span style="font-size:0.92em;flex-shrink:0;">🗝️</span>
          <div style="min-width:0;overflow:hidden;">
            <div style="font-weight:700;font-size:0.74em;color:#EF9090;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">Data Owner / Steward</div>
            <div style="font-size:0.63em;color:#456070;line-height:1.2;">รู้สถานะข้อมูล มี Alert แจ้งเตือนอัตโนมัติ</div>
          </div>
        </div>
        <div style="display:flex;align-items:center;gap:0.32em;background:rgba(239,83,80,0.06);border-left:2px solid rgba(239,83,80,0.28);border-radius:0 5px 5px 0;padding:0.13em 0.4em;">
          <span style="font-size:0.92em;flex-shrink:0;">🔐</span>
          <div style="min-width:0;overflow:hidden;">
            <div style="font-weight:700;font-size:0.74em;color:#EF9090;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">ทีม IT / Security</div>
            <div style="font-size:0.63em;color:#456070;line-height:1.2;">ลดความเสี่ยง Credential ปะปน PII Exposure</div>
          </div>
        </div>
        <div style="display:flex;align-items:center;gap:0.32em;background:rgba(239,83,80,0.06);border-left:2px solid rgba(239,83,80,0.28);border-radius:0 5px 5px 0;padding:0.13em 0.4em;">
          <span style="font-size:0.92em;flex-shrink:0;">📊</span>
          <div style="min-width:0;overflow:hidden;">
            <div style="font-weight:700;font-size:0.74em;color:#EF9090;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">ผู้บริหาร ETDA</div>
            <div style="font-size:0.63em;color:#456070;line-height:1.2;">เข้าถึง Data Catalog · ตัดสินใจด้วยข้อมูลได้เร็ว</div>
          </div>
        </div>
        <div style="display:flex;align-items:center;gap:0.32em;background:rgba(239,83,80,0.06);border-left:2px solid rgba(239,83,80,0.28);border-radius:0 5px 5px 0;padding:0.13em 0.4em;">
          <span style="font-size:0.92em;flex-shrink:0;">🏢</span>
          <div style="min-width:0;overflow:hidden;">
            <div style="font-weight:700;font-size:0.74em;color:#EF9090;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">พนักงานทั่วไป</div>
            <div style="font-size:0.63em;color:#456070;line-height:1.2;">จัดเก็บและใช้งานข้อมูลมีประสิทธิภาพขึ้น</div>
          </div>
        </div>
        <div style="display:flex;align-items:center;gap:0.32em;background:rgba(239,83,80,0.06);border-left:2px solid rgba(239,83,80,0.28);border-radius:0 5px 5px 0;padding:0.13em 0.4em;">
          <span style="font-size:0.92em;flex-shrink:0;">🤖</span>
          <div style="min-width:0;overflow:hidden;">
            <div style="font-weight:700;font-size:0.74em;color:#EF9090;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">ทีม Data Science / AI</div>
            <div style="font-size:0.63em;color:#456070;line-height:1.2;">ฐานข้อมูลสะอาด มี Label พร้อมต่อยอด Technology ใหม่</div>
          </div>
        </div>
      </div>
